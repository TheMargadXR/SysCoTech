...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-4 z-40 ">
      <div className="flex justify-between cursor-pointer items-center max-w-full m-4 px-4 h-12 text-[#efc2b3] bg-[#1a2456]  ">
        ...
        <ul className="hidden md:flex cursor-pointer items-center text-xs">
          ...
          <li className="p-4 flex hover:text-[#fe7a52]">
            USD <MdArrowDropDown />
          </li>
        </ul>
      ...
      <div className="block md:hidden ">
        <div
          className={
            !nav
              ? "fixed h-full left-0 top-0 w-[50%] text-[#c4745c] bg-[#1a2456] ease-in-out duration-500"
              : "fixed left-[-100%] hidden md:flex "
          }
        >
          <ul className="p-4 items-center">
            <div className="flex items-center ">
              <li className="flex text-2xl items-center m-4 ">
                <PiRectangleThin size={40} className="mr-2 ml-2" />
                Monogram{" "}
              </li>
            ...
            <li className="p-4 border-b border-[#4052ac] ml-10">
              AUDIO CONSOLE
            </li>
            <li className="p-4 border-b border-[#4052ac] ml-10">
              PHOTO CONSOLE
