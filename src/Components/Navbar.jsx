    ...
    <div className="sticky top-4 z-40 ">
      ...
      <div className="block md:hidden ">
        <div
          className={
            !nav
              ? "fixed h-full left-0 top-0 w-[50%] text-[#efc2b3] bg-[#1a2456] ease-in-out duration-500"
              : "fixed left-[-100%] hidden md:flex "
          }
        >
          <ul className="p-4 items-center cursor-pointer">
            <div className="flex items-center ">
            ...
            <li className="p-4 border-b hover:text-[#fe7a52] duration-100 border-[#4052ac] ml-10">
              AUDIO CONSOLE
            </li>
            <li className="p-4 border-b hover:text-[#fe7a52] duration-100 border-[#4052ac] ml-10">
              PHOTO CONSOLE
